                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">
                                    {{ number_format(App\Models\Auction::groupBy('product_id')->orderBy('auction_price', 'DESC')->sum('auction_price') - App\Models\Product::join('auctions', 'products.id', '=', 'auctions.product_id')->sum('start_from'),0,',','.') }}
                                </h3>
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <span>Rp.</span>
                                <h3 class="card-title mb-2">
                                    {{ number_format(App\Models\Auction::groupBy('product_id')->orderBy('auction_price', 'DESC')->sum('auction_price'),0,',','.') }}
                                </h3>
