...
use App\Http\Controllers\{CoreController,AppointmentController,CategoryController,AdminController,ProductController,AuctionController,BannerController,EventController,HelpCenterController,ApiController,UserController,NotificationController};
...
Route::get('lang/change', [CoreController::class, 'change'])->name('changeLang');
...
Route::get('/', function () {
    ...
    $banner = Banner::limit(3)->orderBy('id','DESC')->get();
    $event = Event::limit(10)->orderBy('start_at','DESC')->get();
...
Route::get('/chat', [CoreController::class, 'chat'])->name('chat');
    ...
    Route::get('/get-snap-token/{id}', [CoreController::class,'getSnapToken'])->name('get-snap-token');
     Route::get('/appointment', [CoreController::class, 'appointment'])->name('appointment');
    Route::post('/set-appointment', [CoreController::class, 'setAppointment'])->name('set-appointment');
});




Route::prefix('admin')->name('admin.')->middleware(['auth','verified','checkRole:2,3'])->group(function () {
    ...
    Route::prefix('notifications')->group(function () {
     ...
     Route::prefix('appointment')->group(function () {
        ...
        Route::post('/change', [AppointmentController::class,'change'])->name('appointment.change');
        Route::get('/detail/{id}', [AppointmentController::class,'detail'])->name('appointment.detail');
