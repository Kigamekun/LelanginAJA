...
*/
    ...
    <div class="web-container">
        ...
        <table class="line-items-container" style="table-layout:fixed;">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:40%">{{ $data->product->name }}</td>
                    <td style="width:25%" class="right">Rp.{{ number_format($data->product->start_from, 0, ',', '.') }}</td>
                    <td style="width:30%" class="bold">Rp.{{ number_format($data->auction_price, 0, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="line-items-container has-bottom-border">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:30%" class="">{{ date('d F Y', strtotime(now())) }}</td>
                    <td style="width:30%" class="large total">Rp.{{ number_format($data->auction_price, 0, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
