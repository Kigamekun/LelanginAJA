                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            ...
                                            data-start_from="{{ number_format($item->start_from, 0, ',', '.') }}"
                                        ...
                                        <a class="btn btn-danger btn-delete"
                                            href="{{ route('admin.product.delete', ['id' => $item->id]) }}"><i class='bx bx-trash' ></i></a>
                                             <a class="btn btn-danger m-3 "
                                            href="/admin/auction?id={{$item->id}}"><i class='bx bx-info-circle'></i></a>
                                        <a class="btn btn-danger m-3 "
                                            href="{{ route('admin.product.stop', ['id' => $item->id]) }}"><i class='bx bx-stop-circle' ></i></a>
...
<script src="https://cdn.datatables.net/buttons/2.3.5/js/buttons.print.min.js"></script>
            ...
            <div class="modal-header">
                ...
                <form action="${$(e.relatedTarget).data('url')}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="start_from" class="form-label">Start From</label>
                            <input type="text" class="form-control" id="start_from_edit" name="start_from" placeholder="Enter start from value auction"
                            value="${$(e.relatedTarget).data('start_from')}" onkeyup="this.value = formatRupiah(this.value);" required>
                        </div>
                        <div class="mb-3">
    ...
    <script>
     ...
     <script>
      var start_from = document.getElementById('start_from');
    start_from.addEventListener('keyup', function(e)
    {
        start_from.value = formatRupiah(this.value);
    });
